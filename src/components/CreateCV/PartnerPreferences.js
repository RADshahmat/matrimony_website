  ...
  const handleSubmit = async (e) => {
    ...
    const compressedImages = await Promise.all(
      images.map(async (image) => {
        ...
        return new File([compressedBlob], `${props.formDataFunc.fullName}.webp`, { type: 'image/webp' });
      })
    );
  ...
  return (
    <div className={styles.container}>
      <form encType="multipart/form-data" onSubmit={handleSubmit}>
        <h4 className={styles.title}>Personal Preferences For Partners (Optional)</h4>
        <div className={styles.row}>
          <div className={styles.column}>
            ...
            <Select
              options={options.age}
              name="age"
              value={options.age.find(option => option.value === formData.age)}
          ...
          <div className={styles.column}>
            ...
            <Select
              ...
              name="height"
              value={options.height.find(option => option.value === formData.height)}
              onChange={handleChange}
            />
          </div>
        </div>
        ...
        <div className={styles.row}>
          ...
          <div className={styles.column}>
            ...
            <Select
              ...
              value={options.educationalQualification.find(option => option.value === formData.educationalQualification)}
              onChange={handleChange}
            />
          </div>
        </div>
          ...
          <div className={styles.column}>
            ...
            <div className={styles.inputGroup}>
              <Select
                ...
                value={options.heightPreference.find(option => option.value === formData.heightPreference)}
                onChange={handleChange}
              />
              <input
                type="text"
          ...
          <div className={styles.column}>
            ...
            <div className={styles.inputGroup}>
              <Select
                ...
                name="agePreference"
                value={options.agePreference.find(option => option.value === formData.agePreference)}
                onChange={handleChange}
              />
              <input
                type="text"
        ...
        <div className={styles.row}>
          ...
          <div className={styles.column}>
            <label className={styles.label}>Minimum Educational Qualification</label>
            <Select
              options={options.minimumEducationalQualification}
              name="minimumEducationalQualification"
              value={options.minimumEducationalQualification.find(option => option.value === formData.minimumEducationalQualification)}
              onChange={handleChange}
            />
          </div>
        </div>

        <label className={styles.label}>Additional Image: {images.length}/10</label>
        ...
        <div className={styles.buttonGroup}>
          <button type="button" onClick={prev} className={styles.backButton}>Previous</button>
